      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i>Danh sách danh mục</a></li>
              <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i>Thêm danh mục</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i>Danh sách sản phẩm</a></li>
